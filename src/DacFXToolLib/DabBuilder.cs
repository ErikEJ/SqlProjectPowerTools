...
namespace DacFXToolLib
{
    public class DabBuilder
    {
        ...
        public string GetDabConfigCmdFile()
        {
            ...
            sb.AppendLine(CultureInfo.InvariantCulture, $"@echo This cmd file creates a SQL MCP Server configuration powered by Data API Builder based on the chosen database objects.");
