...
[Getting Started Guide](docs/getting-started.md) | [Getting started with SQL MCP Server](docs/dab-mcp-readme.md) | [Overview blog post: SQL Project Power Tools for Visual Studio](https://erikej.github.io/dotnet/dacfx/sqlserver/visualstudio/2025/09/30/sqlproj-power-tools-visualstudio.html)
